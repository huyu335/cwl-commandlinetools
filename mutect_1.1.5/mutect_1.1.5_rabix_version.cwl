...
inputs:
  ...
  - default: false
    ...
    doc: >-
      Should we override the Walker's default and keep program records from the
      SAM header
  - id: log_to_file
    type: 'string[]?'
    inputBinding:
  ...
  - id: logging_level
    ...
    doc: >-
      Set the minimum level of logging, i.e. setting INFO get's you INFO up to
  ...
  - id: preserve_qscores_less_than
    ...
    doc: >-
      Bases with quality scores less than this threshold won't be recalibrated
      (with -BQSR)
  - id: read_buffer_size
    type: 'string[]?'
    inputBinding:
  ...
  - default: false
    ...
    doc: >-
      Should we override the Walker's default and remove program records from
      the SAM header
  - default: false
